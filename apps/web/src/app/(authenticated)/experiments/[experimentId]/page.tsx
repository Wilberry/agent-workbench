        ...
        <div className="rounded-3xl border border-slate-700 bg-slate-900 p-6">
          <div className="space-y-6">
            ...
            {experiment.status === 'running' && (
              <div className="rounded-3xl border border-blue-700 bg-blue-950/20 p-4 text-sm text-blue-200">
                Experiment is currently running. Refresh after execution completes to view metrics.
              </div>
            )}
          </div>
        </div>
